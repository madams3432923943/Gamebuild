...
import { DEFAULT_SPORT } from "./constants.js";
...
export async function challengeFriend(friendId, sport = DEFAULT_SPORT) {
  await requireSession();
  return callRpc("challenge_friend", { p_friend_id: friendId, p_sport: sport });
}
