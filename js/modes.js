...
/** The two modes the Play screen offers, drawn in this order: the headline mode
 * first, because burying Online Ranked under the practice mode reads as the
 * practice mode being the point. The card that starts SELECTED is Practice
 * (`selectedMode` in js/main.js), which is where a player with no rank belongs.
 *
