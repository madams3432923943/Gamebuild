...
export const FRANCHISES = [
  { id: "hawks", name: "Atlanta Hawks", abbr: "ATL", sport: "nba", city: "Atlanta", colors: ["#e03a3e", "#26282a"], aliases: [] },
  { id: "celtics", name: "Boston Celtics", abbr: "BOS", sport: "nba", city: "Boston", colors: ["#007a33", "#ba9653"], aliases: [] },
  {
    id: "nets",
    name: "Brooklyn Nets",
    abbr: "BKN",
    sport: "nba", city: "Brooklyn",
  ...
  },
  {
    ...
    abbr: "CHA",
    sport: "nba", city: "Charlotte",
    colors: ["#1d1160", "#00788c"],
    aliases: ["Charlotte Bobcats"],
  },
  { id: "bulls", name: "Chicago Bulls", abbr: "CHI", sport: "nba", city: "Chicago", colors: ["#ce1141", "#000000"], aliases: [] },
  { id: "cavaliers", name: "Cleveland Cavaliers", abbr: "CLE", sport: "nba", city: "Cleveland", colors: ["#860038", "#fdbb30"], aliases: [] },
  { id: "mavericks", name: "Dallas Mavericks", abbr: "DAL", sport: "nba", city: "Dallas", colors: ["#00538c", "#002b5e"], aliases: [] },
  { id: "nuggets", name: "Denver Nuggets", abbr: "DEN", sport: "nba", city: "Denver", colors: ["#0e2240", "#fec524"], aliases: [] },
  { id: "pistons", name: "Detroit Pistons", abbr: "DET", sport: "nba", city: "Detroit", colors: ["#c8102e", "#1d42ba"], aliases: [] },
  { id: "warriors", name: "Golden State Warriors", abbr: "GSW", sport: "nba", city: "Golden State", colors: ["#1d428a", "#ffc72c"], aliases: [] },
  { id: "rockets", name: "Houston Rockets", abbr: "HOU", sport: "nba", city: "Houston", colors: ["#ce1141", "#000000"], aliases: [] },
  { id: "pacers", name: "Indiana Pacers", abbr: "IND", sport: "nba", city: "Indiana", colors: ["#002d62", "#fdbb30"], aliases: [] },
  {
    id: "clippers",
    name: "LA Clippers",
    abbr: "LAC",
  ...
  { id: "lakers", name: "LA Lakers", abbr: "LAL", sport: "nba", city: "LA", colors: ["#552583", "#fdb927"], aliases: ["Los Angeles Lakers"] },
  {
    id: "grizzlies",
    name: "Memphis Grizzlies",
    abbr: "MEM",
    sport: "nba", city: "Memphis",
    colors: ["#5d76a9", "#12173f"],
    aliases: ["Vancouver Grizzlies"],
  },
  { id: "heat", name: "Miami Heat", abbr: "MIA", sport: "nba", city: "Miami", colors: ["#98002e", "#f9a01b"], aliases: [] },
  { id: "bucks", name: "Milwaukee Bucks", abbr: "MIL", sport: "nba", city: "Milwaukee", colors: ["#00471b", "#eee1c6"], aliases: [] },
  { id: "timberwolves", name: "Minnesota Timberwolves", abbr: "MIN", sport: "nba", city: "Minnesota", colors: ["#0c2340", "#78be20"], aliases: [] },
  {
    id: "pelicans",
    name: "New Orleans Pelicans",
    abbr: "NOP",
    sport: "nba", city: "New Orleans",
    colors: ["#0c2340", "#c8102e"],
    aliases: ["New Orleans Hornets", "New Orleans Hornets/Pelicans"],
  },
  { id: "knicks", name: "New York Knicks", abbr: "NYK", sport: "nba", city: "New York", colors: ["#006bb6", "#f58426"], aliases: [] },
  {
    ...
    abbr: "OKC",
    sport: "nba", city: "Oklahoma City",
    colors: ["#007ac1", "#ef3b24"],
    aliases: ["Oklahoma City Thunder", "Seattle SuperSonics", "Seattle SuperSonics / OKC Thunder"],
  },
  { id: "magic", name: "Orlando Magic", abbr: "ORL", sport: "nba", city: "Orlando", colors: ["#0077c0", "#c4ced4"], aliases: [] },
  { id: "sixers", name: "Philadelphia 76ers", abbr: "PHI", sport: "nba", city: "Philadelphia", colors: ["#006bb6", "#ed174c"], aliases: [] },
  { id: "suns", name: "Phoenix Suns", abbr: "PHX", sport: "nba", city: "Phoenix", colors: ["#1d1160", "#e56020"], aliases: [] },
  { id: "blazers", name: "Portland Trail Blazers", abbr: "POR", sport: "nba", city: "Portland", colors: ["#e03a3e", "#000000"], aliases: [] },
  { id: "kings", name: "Sacramento Kings", abbr: "SAC", sport: "nba", city: "Sacramento", colors: ["#5a2d81", "#63727a"], aliases: [] },
  { id: "spurs", name: "San Antonio Spurs", abbr: "SAS", sport: "nba", city: "San Antonio", colors: ["#c4ced4", "#000000"], aliases: [] },
  { id: "raptors", name: "Toronto Raptors", abbr: "TOR", sport: "nba", city: "Toronto", colors: ["#ce1141", "#000000"], aliases: [] },
  { id: "jazz", name: "Utah Jazz", abbr: "UTA", sport: "nba", city: "Utah", colors: ["#002b5c", "#00471b"], aliases: [] },
  {
    id: "wizards",
    name: "Washington Wizards",
    abbr: "WAS",
    sport: "nba", city: "Washington",
  ...
  { id: "nfl-jets", name: "New York Jets", abbr: "NYJ", sport: "nfl", city: "New York", colors: ["#125740", "#000000"], aliases: [] },
  { id: "nfl-ravens", name: "Baltimore Ravens", abbr: "BAL", sport: "nfl", city: "Baltimore", colors: ["#241773", "#000000"], aliases: [] },
  { id: "nfl-bengals", name: "Cincinnati Bengals", abbr: "CIN", sport: "nfl", city: "Cincinnati", colors: ["#fb4f14", "#000000"], aliases: [] },
  { id: "nfl-browns", name: "Cleveland Browns", abbr: "CLE", sport: "nfl", city: "Cleveland", colors: ["#311d00", "#ff3c00"], aliases: [] },
  { id: "nfl-steelers", name: "Pittsburgh Steelers", abbr: "PIT", sport: "nfl", city: "Pittsburgh", colors: ["#ffb612", "#101820"], aliases: [] },
  { id: "nfl-texans", name: "Houston Texans", abbr: "HOU", sport: "nfl", city: "Houston", colors: ["#03202f", "#a71930"], aliases: [] },
  { id: "nfl-colts", name: "Indianapolis Colts", abbr: "IND", sport: "nfl", city: "Indianapolis", colors: ["#002c5f", "#a2aaad"], aliases: [] },
  { id: "nfl-jaguars", name: "Jacksonville Jaguars", abbr: "JAX", sport: "nfl", city: "Jacksonville", colors: ["#101820", "#d7a22a"], aliases: [] },
  { id: "nfl-titans", name: "Tennessee Titans", abbr: "TEN", sport: "nfl", city: "Tennessee", colors: ["#0c2340", "#4b92db"], aliases: [] },
  { id: "nfl-broncos", name: "Denver Broncos", abbr: "DEN", sport: "nfl", city: "Denver", colors: ["#fb4f14", "#002244"], aliases: [] },
  { id: "nfl-chiefs", name: "Kansas City Chiefs", abbr: "KC", sport: "nfl", city: "Kansas City", colors: ["#e31837", "#ffb81c"], aliases: [] },
  { id: "nfl-raiders", name: "Las Vegas Raiders", abbr: "LV", sport: "nfl", city: "Las Vegas", colors: ["#000000", "#a5acaf"], aliases: [] },
  { id: "nfl-chargers", name: "Los Angeles Chargers", abbr: "LAC", sport: "nfl", city: "Los Angeles", colors: ["#0080c6", "#ffc20e"], aliases: [] },
  { id: "nfl-cowboys", name: "Dallas Cowboys", abbr: "DAL", sport: "nfl", city: "Dallas", colors: ["#041e42", "#869397"], aliases: [] },
  { id: "nfl-giants", name: "New York Giants", abbr: "NYG", sport: "nfl", city: "New York", colors: ["#0b2265", "#a71930"], aliases: [] },
  { id: "nfl-eagles", name: "Philadelphia Eagles", abbr: "PHI", sport: "nfl", city: "Philadelphia", colors: ["#004c54", "#a5acaf"], aliases: [] },
  { id: "nfl-commanders", name: "Washington Commanders", abbr: "WAS", sport: "nfl", city: "Washington", colors: ["#5a1414", "#ffb612"], aliases: [] },
  { id: "nfl-bears", name: "Chicago Bears", abbr: "CHI", sport: "nfl", city: "Chicago", colors: ["#0b162a", "#c83803"], aliases: [] },
  { id: "nfl-lions", name: "Detroit Lions", abbr: "DET", sport: "nfl", city: "Detroit", colors: ["#0076b6", "#b0b7bc"], aliases: [] },
  { id: "nfl-packers", name: "Green Bay Packers", abbr: "GB", sport: "nfl", city: "Green Bay", colors: ["#203731", "#ffb612"], aliases: [] },
  { id: "nfl-vikings", name: "Minnesota Vikings", abbr: "MIN", sport: "nfl", city: "Minnesota", colors: ["#4f2683", "#ffc62f"], aliases: [] },
  { id: "nfl-falcons", name: "Atlanta Falcons", abbr: "ATL", sport: "nfl", city: "Atlanta", colors: ["#a71930", "#000000"], aliases: [] },
  { id: "nfl-panthers", name: "Carolina Panthers", abbr: "CAR", sport: "nfl", city: "Carolina", colors: ["#0085ca", "#101820"], aliases: [] },
  { id: "nfl-saints", name: "New Orleans Saints", abbr: "NO", sport: "nfl", city: "New Orleans", colors: ["#d3bc8d", "#101820"], aliases: [] },
  { id: "nfl-buccaneers", name: "Tampa Bay Buccaneers", abbr: "TB", sport: "nfl", city: "Tampa Bay", colors: ["#d50a0a", "#34302b"], aliases: [] },
  { id: "nfl-cardinals", name: "Arizona Cardinals", abbr: "ARI", sport: "nfl", city: "Arizona", colors: ["#97233f", "#000000"], aliases: [] },
  { id: "nfl-rams", name: "Los Angeles Rams", abbr: "LAR", sport: "nfl", city: "Los Angeles", colors: ["#003594", "#ffa300"], aliases: [] },
  { id: "nfl-49ers", name: "San Francisco 49ers", abbr: "SF", sport: "nfl", city: "San Francisco", colors: ["#aa0000", "#b3995d"], aliases: [] },
  { id: "nfl-seahawks", name: "Seattle Seahawks", abbr: "SEA", sport: "nfl", city: "Seattle", colors: ["#002244", "#69be28"], aliases: [] },
];
