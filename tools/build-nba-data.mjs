// Builds data/nba-players.json from tools/seasons/NBAdata1980-2025.xlsx.
//
...
const OUT = join(here, "..", "data", "nba-players.json");
...
// JSON, not a JS module. The browser parsed 5.2MB of football as JAVASCRIPT
// to reach a draft board; JSON.parse is 4.7x faster on the identical payload.
// See data/README.md.
//
// The squad comments that used to break this file up went with it - JSON has
// nowhere to put them - and the rows are still written in squad order, so the
// file diffs the same way. What the comments were for, a human reading the
// dataset, is better served by the header in data/README.md than by 153
// section markers inside a 2MB array nobody opens.
